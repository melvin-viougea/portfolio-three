...
import {personnalProjects} from "../constants";
    ...
    return (
        <>
            <motion.div variants={textVariant()}>
                ...
                <h2 className={`${styles.sectionHeadText}`}>Projets personnels.</h2>
            </motion.div>
...
export default SectionWrapper(PersonalProjects, "personalProjects");
